...
#ifndef soapaddService_H
#define soapaddService_H
#include "soapH.h"
class SOAP_CMAC addService : public soap
{ public:
	/// Variables globally declared in add.h (non-static)
	/// Constructor
	addService();
	/// Copy constructor
	addService(const addService&);
	/// Construct from another engine state
	addService(const struct soap&);
	/// Constructor with engine input+output mode control
	addService(soap_mode iomode);
	/// Constructor with engine input and output mode control
	addService(soap_mode imode, soap_mode omode);
	...
	virtual	void addService_init(soap_mode imode, soap_mode omode);
	/// Create a new copy
	virtual	addService *copy() SOAP_PURE_VIRTUAL;
	/// Copy assignment
	addService& operator=(const addService&);
	...
	virtual	int add(int a, int b, int *result) SOAP_PURE_VIRTUAL;
};
#endif
